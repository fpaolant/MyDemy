...
function TreeSortable(options) {
    ...
    this.setOnlyLeafRemoveButton = function () {
        const $elements = $(`${self.options.treeSelector} ${self.options.branchSelector}`);
        $elements.each(function () {
            const element = $(this).get(0);
            $(element).find(".remove-branch").css("display", "none");
        });
        ...
        $elements.each(function () {
            ...
            if(lastChild.length === 0) {
                element.find(".remove-branch").css("display", "revert");
            } else {
                lastChild.find(".remove-branch").css("display", "revert");
            }
        });
    };
            ...
            <div class="contents">
                ...
                <div class="branch-wrapper">
                    <div class="left-sidebar">
                        <div class="${self.cleanSelector(dragHandlerSelector)} btn-link">
                           <i class="fa fa-arrows-alt"></i>
                        </div>
                        <span class="branch-title">${title}</span>
                    </div>
                    <div class="right-sidebar">
                        <button type="button" class="btn btn-link btn-xs add-child" data-tippy-content="Aggiungi un figlio">
                            <i class="fa fa-plus"></i>
                        </button>
                        <button type="button" class="btn btn-link btn-xs add-sibling" data-tippy-content="Aggiungi un sulla stessa gerarchia">
                            <i class="fa fa-edit"></i>
                        </button>
                        <button type="button" class="btn btn-link btn-xs remove-branch" data-tippy-content="Rimuovi ramo">
    ...
    this.getId = function ($triggerElement) {
        const {
            treeSelector,
            branchSelector,
            dataAttributes: { id },
